<%-- 
    Document   : welcome
    Created on : Feb 28, 2019, 1:29:05 PM
    Author     : hp
--%>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="page_title">
                    <center><h2>உங்களை வரவேற்கிறோம்</h2></center>
                </div>
            </div>
        </div>
    </div>
...
<!--End Header-->
 <li class="list_item col-lg-3 col-md-4 col-sm-6 mobile">
                                <figure class="touching effect-bubba">
                                    <img src="images/motors/12.jpg" alt=""/>
                                </figure>
                                ...
                                <li class="list_item col-lg-3 col-md-4 col-sm-6 mobile">
                                <figure class="touching effect-bubba">
                                    <img src="images/motors/13.jpg" alt=""/>
                                ...
                                <li class="list_item col-lg-3 col-md-4 col-sm-6 mobile">
                                <figure class="touching effect-bubba">
                                    <img src="images/motors/14.png" alt=""/>
                                </figure>
                               
				</li>
                                 <li class="list_item col-lg-3 col-md-4 col-sm-6 mobile">
                                <figure class="touching effect-bubba">
                                    <img src="images/motors/18.jpeg" alt=""/>
                                </figure>
...
<section class="footer_bottom">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <p class="copyright">&copy; Copyright 2019 Tamil Vivasayi  </p>
            </div>
        </div>
    </div>
</section>
